...
public class ProjectGeneratorImplNck implements ProjectGenerator {
    ...
    public void generate(Project project) {
        ...
        project.setNckAutoPath((path + AutoConstants.PATH_TEMPLATES + "nck/").replace("bin", "src"));
        ...
        project.setDaoPath( project.getNckOutputPath() + "/java/" + (project.getDaoPackage()).replace(".", "/") + "/");
