...
public class NckEntityFileUtils {
	...
	/** nck bean 类 ***/
	public static String setNckClass(File fileName, File writeFile, List<ClellBean> clLs, String path, String type)
			throws Exception {
		...
		for (ClellBean clell : clLs) {
			...
			if ("Date".equals(clell.type)) {
				if ("property".equals(type)) {
					fileName = new File(path + "propertyDateFragment.txt");
				} else if ("method".equals(type)) {
					fileName = new File(path + "methodDateFragment.txt");
				}
			} else {
				if ("property".equals(type)) {
					fileName = new File(path + "propertyFragment.txt");
				} else if ("method".equals(type)) {
					fileName = new File(path + "methodFragment.txt");
				}
			}
